...
$result = mysqli_query($con,"SELECT * FROM `quiz` ORDER BY RAND()") or die('Error');
...
<script type="text/javascript">
      ...
      function setCountDown ()
      {
          ...
          if (minutes == '00' && seconds == '00') { 
              ...
              window.location = "update.php?q=quiz&step=7&eid=<?php echo $eid; ?>&n=<?php echo $sn; ?>&t=<?php echo $total; ?>&qid=<?php echo $qid; ?>&ans=''"
...
<?php }
  ...
  echo "<script>window.open('airtimequiz_start.php','_self')</script>";
}
?>