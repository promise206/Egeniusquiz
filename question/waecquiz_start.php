...
$sel_user = "SELECT * FROM `profquiz` WHERE `email` = '$subscriber' ";
$run_user = mysqli_query($con, $sel_user);
$check_user = mysqli_num_rows($run_user);
if($check_user<=0){
  echo "<script>alert('Sorry you didn't register for the quiz!')</script>";
  echo "<script>window.open('waecquiz.php?page_url=$redirect_link_var','_self')</script>";
}
$sel_active = "SELECT * FROM `profquiz` WHERE `email` = '$subscriber' AND active='1' ";
...
<html lang="en">
<head>
  <title>Waecquiz - Egeniusquiz</title>
    ...
    <div class="box">
      <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 "><div class="grey-box">
          ...
          <ul id="grey-box">
              ...
              <li><b><p><a href="waecquiz_start.php">&nbsp;<b>Back to Question</b></a></p></b></li>
							<li><b><p <?php if(@$_GET['q']==2) echo'class="active"'; ?>><a href="waecquiz_start.php?q=2">History</a></b></li>
							<li><b><p <?php if(@$_GET['q']==3) echo'class="active"'; ?>><a href="waecquiz_start.php?q=3">Ranking</a></b></li>
...
if($rowcount == 0){
	...
	<td><b><a href="waectimer_action.php?q=quiz&step=2&eid='.$eid.'&n=1&t='.$total.'" class="pull btn sub1" style="margin:0px;background:#2b5f05"><span class="glyphicon glyphicon-new-window" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Start</b></span></a></b></td></tr>';
}
else
{
...
$que=mysqli_query($con,"SELECT * FROM waecrank  ORDER BY score DESC  LIMIT $offset,$limit" )or die('Error223');
echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
