    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <?php
            include('database/db.php');
            $get_total_quiz = "SELECT * FROM `quiz` ";
            $run_total_quiz = mysqli_query($con, $get_total_quiz);
            $get_total_quiz = mysqli_num_rows($run_total_quiz);
          ?>
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-warning o-hidden h-100">
              <div class="card-body">
                ...
                <div class="mr-5"><?php echo $get_total_quiz; ?> Quiz!</div>
              </div>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-success o-hidden h-100">
              <div class="card-body">
                ...
                <div class="mr-5"><?php echo $get_reg_prof; ?> Total Registration for Professional!</div>
              </div>
