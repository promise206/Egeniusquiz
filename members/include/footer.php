 ...
 <footer class="bg-191 color-ccc">
		...
		<div class="container">
			...
			<div class="oflow-hidden color-ash font-9 text-sm-center ptb-sm-5">
				...
				<ul class="float-left float-sm-none list-a-plr-10 list-a-plr-sm-5 list-a-ptb-15 list-a-ptb-sm-10">
					<li><p class="color-ash"><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
					Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved |Designed by </li><li> <a href="https://egeniusquiz.com" target="_blank">Promsy Tech</a>
