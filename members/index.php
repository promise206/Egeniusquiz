...
if(!isset($_SESSION['email'])){
  echo "<script>window.open('login.php?page_url=$redirect_link_var&message=Login to View the Quiz!', '_self')</script>";
}
else{
?>
<html lang="en">
        ...
        if (isset($_GET['blog'])) {
         ...
         if (isset($_GET['ref'])) {
            ...
            if($check_user>0) {
              ...
              {
                $protocols="HTTP://egeniusquiz.com/members/register.php?ref=$ref_code";
              }
                echo '
