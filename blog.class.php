...
class blog
{
    ...
    Public function entertainment(){
        return ('<div class="form-box">
              ...
              <h1 style="text-align: center; color: #46594c;font-size: 20px; font-weight: bolder;">Entertainment and Sports</h1>   <form class="form-horizontal title1" name="form" action="../ent_action.php" enctype="multipart/form-data" method="POST">
        <fieldset>
